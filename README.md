...
游客上传消费票据后，由 AI 完成 OCR + 风控识别，通过后进入盲盒抽奖，获得可在合作商户使用的消费券，并沉淀成长积分兑换权益。

![消费者端](assets/消费者端.png)

### 商户端

商户在门店侧通过小程序/H5 扫码验券、完成核销，并查看核销流水、券种分布与营收统计，支撑本地消费闭环的最后一公里。

![商户端](assets/商户端.png)

### 后台运营端

运营/审核人员在管理后台完成人工审票、盲盒与券模板配置、商户与门店管理，以及核销数据、积分流水与经营看板的统一监控。

![后台运营端](assets/后台运营.png)
